...
* **AWS Windows Licence Included now available for {product-title}.** You can now add a Windows Licence Included enabled machine pool to a {product-title} cluster. For more information, see link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html/cluster_administration/managing-compute-nodes-using-machine-pools#creating_machine_pools_cli_rosa-managing-worker-nodes[Managing compute nodes].
